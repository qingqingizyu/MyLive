...
public class MoreActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        Toolbar toolBar = (Toolbar) findViewById(R.id.more_tool_bar);
        TextView tvTitle = (TextView) findViewById(R.id.more_tvTitle);
        ...
        transaction.replace(R.id.more_layout,fragment);
        transaction.commit();
        //处理返回按钮
